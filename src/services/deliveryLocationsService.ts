...
// 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Coordinate order configuration
// 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Set to 'lng-lat' if DB stores coordinates as [longitude, latitude] (e.g., [54.37, 24.46])
// 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Set to 'lat-lng' if DB stores coordinates as [latitude, longitude] (e.g., [24.46, 54.37])
// 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Set to 'auto' to auto-detect based on value ranges (default, most flexible)
    ...
    if (Array.isArray(pair)) {
      ...
      if (Number.isFinite(first) && Number.isFinite(second)) {
        ...
        if (POLYGON_COORDINATE_ORDER === 'lng-lat') {
          // 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Force [lng, lat] interpretation: first is longitude, second is latitude
          lng = first;
          lat = second;
        } else if (POLYGON_COORDINATE_ORDER === 'lat-lng') {
          // 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Force [lat, lng] interpretation: first is latitude, second is longitude
          lat = first;
          lng = second;
        } else {
          // 2025-11-12T00:00:00Z 🟡🟡🟡 - [deliveryLocationsService] Auto-detect: heuristic to determine ordering
          lat = second;
          lng = first;
...
function ensureArray(value: unknown, context: { district: string; city: string }): any[] {
