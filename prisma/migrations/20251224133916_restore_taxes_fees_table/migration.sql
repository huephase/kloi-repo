...
-- CreateIndex
CREATE UNIQUE INDEX "taxesFees_code_key" ON "taxesFees"("code");

-- CreateIndex
CREATE INDEX "taxesFees_country_code_idx" ON "taxesFees"("country_code");

-- CreateIndex
CREATE INDEX "taxesFees_active_idx" ON "taxesFees"("active");

-- CreateIndex
CREATE INDEX "taxesFees_dates_idx" ON "taxesFees"("startDate", "endDate");
